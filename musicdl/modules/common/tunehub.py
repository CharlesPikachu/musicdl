                ...
                if search_result['source'] in {'netease', 'qq'}:
                    for br in (TuneHubMusicClient.BAKA_MUSIC_QUALITIES if search_result['source'] in {'netease'} else TuneHubMusicClient.BAKA_MUSIC_QUALITIES[:1]):
                        ...
                        song_info = SongInfo(
                            ...
                            ext=self._parseextfromurl(str(download_url)), file_size_bytes=None, file_size=None, identifier=search_result['id'], duration='-:-:-', 
                    ...
                    for quality in TuneHubMusicClient.MUSIC_QUALITIES:
                        ...
                        song_info = SongInfo(
                            ...
                            album=legalizestring(safeextractfromdict(search_result, ['album'], None)), ext=self._parseextfromurl(str(download_url)), file_size_bytes=None, file_size=None, identifier=search_result['id'], duration_s=duration_in_secs,
